...
import { n as clipPlaneFragmentDeclarationWGSL, t as clipPlaneFragmentWGSL } from "./clipPlaneFragment-8O9_FWay.js";
...
import { a as pbrUboDeclarationWGSL, i as mainUVVaryingDeclarationWGSL, n as harmonicsFunctionsWGSL, o as meshUboDeclarationWGSL, r as logDepthDeclarationWGSL, s as sceneUboDeclarationWGSL, t as pbrBRDFFunctionsWGSL } from "./pbrBRDFFunctions-CB-CfFmX.js";
//#region node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/prePassDeclaration.js
var name$54 = "prePassDeclaration";
var shader$54 = `#ifdef PREPASS
...
#endif
`;
if (!ShaderStore.IncludesShadersStoreWGSL[name$54]) ShaderStore.IncludesShadersStoreWGSL[name$54] = shader$54;
/** @internal */
...
var name$53 = "oitDeclaration";
var shader$53 = `#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#define MAX_DEPTH 99999.0
var oitDepthSamplerSampler: sampler;var oitDepthSampler: texture_2d<f32>;var oitFrontColorSamplerSampler: sampler;var oitFrontColorSampler: texture_2d<f32>;
#endif
`;
if (!ShaderStore.IncludesShadersStoreWGSL[name$53]) ShaderStore.IncludesShadersStoreWGSL[name$53] = shader$53;
/** @internal */
...
var name$52 = "pbrFragmentExtraDeclaration";
var shader$52 = `varying vPositionW: vec3f;
#if DEBUGMODE>0
...
#endif
`;
if (!ShaderStore.IncludesShadersStoreWGSL[name$52]) ShaderStore.IncludesShadersStoreWGSL[name$52] = shader$52;
/** @internal */
...
var name$51 = "lightUboDeclaration";
var shader$51 = `#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
#endif
`;
if (!ShaderStore.IncludesShadersStoreWGSL[name$51]) ShaderStore.IncludesShadersStoreWGSL[name$51] = shader$51;
/** @internal */
...
var name$50 = "samplerFragmentDeclaration";
var shader$50 = `#ifdef _DEFINENAME_
...
#endif
`;
if (!ShaderStore.IncludesShadersStoreWGSL[name$50]) ShaderStore.IncludesShadersStoreWGSL[name$50] = shader$50;
/** @internal */
...
var name$49 = "samplerFragmentAlternateDeclaration";
var shader$49 = `#ifdef _DEFINENAME_
#if _DEFINENAME_DIRECTUV==1
#define v_VARYINGNAME_UV vMainUV1
#elif _DEFINENAME_DIRECTUV==2
#define v_VARYINGNAME_UV vMainUV2
...
#endif
`;
if (!ShaderStore.IncludesShadersStoreWGSL[name$49]) ShaderStore.IncludesShadersStoreWGSL[name$49] = shader$49;
/** @internal */
var samplerFragmentAlternateDeclarationWGSL = {
	name: name$49,
	shader: shader$49
};
//#endregion
//#region node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/pbrFragmentReflectionDeclaration.js
var name$48 = "pbrFragmentReflectionDeclaration";
var shader$48 = `#ifdef REFLECTION
...
#endif
`;
if (!ShaderStore.IncludesShadersStoreWGSL[name$48]) ShaderStore.IncludesShadersStoreWGSL[name$48] = shader$48;
/** @internal */
...
var name$47 = "pbrFragmentSamplersDeclaration";
var shader$47 = `#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;
if (!ShaderStore.IncludesShadersStoreWGSL[name$47]) ShaderStore.IncludesShadersStoreWGSL[name$47] = shader$47;
/** @internal */
var pbrFragmentSamplersDeclarationWGSL = {
	name: name$47,
	shader: shader$47
};
//#endregion
//#region node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/fogFragmentDeclaration.js
var name$46 = "fogFragmentDeclaration";
var shader$46 = `#ifdef FOG
...
#endif
`;
if (!ShaderStore.IncludesShadersStoreWGSL[name$46]) ShaderStore.IncludesShadersStoreWGSL[name$46] = shader$46;
/** @internal */
...
var name$45 = "textureRepetitionFunctions";
var shader$45 = `#if TEXTURE_REPETITION_MODE>0
...
`;
if (!ShaderStore.IncludesShadersStoreWGSL[name$45]) ShaderStore.IncludesShadersStoreWGSL[name$45] = shader$45;
/** @internal */
...
var name$44 = "subSurfaceScatteringFunctions";
var shader$44 = `fn testLightingForSSS(diffusionProfile: f32)->bool
{return diffusionProfile<1.;}`;
if (!ShaderStore.IncludesShadersStoreWGSL[name$44]) ShaderStore.IncludesShadersStoreWGSL[name$44] = shader$44;
/** @internal */
var subSurfaceScatteringFunctionsWGSL = {
	name: name$44,
	shader: shader$44
};
//#endregion
//#region node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/importanceSampling.js
var name$43 = "importanceSampling";
var shader$43 = `fn hemisphereCosSample(u: vec2f)->vec3f {var phi: f32=2.*PI*u.x;var cosTheta2: f32=1.-u.y;var cosTheta: f32=sqrt(cosTheta2);var sinTheta: f32=sqrt(1.-cosTheta2);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
...
if (!ShaderStore.IncludesShadersStoreWGSL[name$43]) ShaderStore.IncludesShadersStoreWGSL[name$43] = shader$43;
/** @internal */
...
var name$42 = "pbrHelperFunctions";
var shader$42 = `#define MINIMUMVARIANCE 0.0005
...
#endif
`;
if (!ShaderStore.IncludesShadersStoreWGSL[name$42]) ShaderStore.IncludesShadersStoreWGSL[name$42] = shader$42;
/** @internal */
...
var name$41 = "shadowsFragmentFunctions";
var shader$41 = `#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`;
if (!ShaderStore.IncludesShadersStoreWGSL[name$41]) ShaderStore.IncludesShadersStoreWGSL[name$41] = shader$41;
/** @internal */
...
var name$40 = "ltcHelperFunctions";
var shader$40 = `fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
`;
if (!ShaderStore.IncludesShadersStoreWGSL[name$40]) ShaderStore.IncludesShadersStoreWGSL[name$40] = shader$40;
/** @internal */
...
var name$39 = "pbrDirectLightingSetupFunctions";
var shader$39 = `struct preLightingInfo
{lightOffset: vec3f,
...
#endif
`;
if (!ShaderStore.IncludesShadersStoreWGSL[name$39]) ShaderStore.IncludesShadersStoreWGSL[name$39] = shader$39;
/** @internal */
...
var name$38 = "pbrDirectLightingFalloffFunctions";
var shader$38 = `fn computeDistanceLightFalloff_Standard(lightOffset: vec3f,range: f32)->f32
...
if (!ShaderStore.IncludesShadersStoreWGSL[name$38]) ShaderStore.IncludesShadersStoreWGSL[name$38] = shader$38;
/** @internal */
...
var name$37 = "hdrFilteringFunctions";
var shader$37 = `#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
`;
if (!ShaderStore.IncludesShadersStoreWGSL[name$37]) ShaderStore.IncludesShadersStoreWGSL[name$37] = shader$37;
/** @internal */
...
var name$36 = "clusteredLightingFunctions";
var shader$36 = `struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
vLightDirection: vec4f,
vLightFalloff: vec4f,}
...
`;
if (!ShaderStore.IncludesShadersStoreWGSL[name$36]) ShaderStore.IncludesShadersStoreWGSL[name$36] = shader$36;
/** @internal */
...
var name$35 = "pbrBlockReflectance0";
var shader$35 = `var reflectanceF0: f32=reflectivityOut.reflectanceF0;var specularEnvironmentR0: vec3f=reflectivityOut.colorReflectanceF0;var specularEnvironmentR90: vec3f= reflectivityOut.reflectanceF90;
#ifdef ALPHAFRESNEL
...
#endif
`;
if (!ShaderStore.IncludesShadersStoreWGSL[name$35]) ShaderStore.IncludesShadersStoreWGSL[name$35] = shader$35;
/** @internal */
...
var name$34 = "pbrDirectLightingFunctions";
var shader$34 = `#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
...
#endif
`;
if (!ShaderStore.IncludesShadersStoreWGSL[name$34]) ShaderStore.IncludesShadersStoreWGSL[name$34] = shader$34;
/** @internal */
...
var name$33 = "pbrIBLFunctions";
var shader$33 = `#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;
if (!ShaderStore.IncludesShadersStoreWGSL[name$33]) ShaderStore.IncludesShadersStoreWGSL[name$33] = shader$33;
/** @internal */
...
var name$32 = "bumpFragmentMainFunctions";
var shader$32 = `#ifndef TEXRD_DEFINED
fn TEXRD(t: texture_2d<f32>,ts: sampler,uv: vec2f)->vec4f {return textureSample(t,ts,uv);}
#define TEXRD_DEFINED
#endif
...
var name$31 = "bumpFragmentFunctions";
var shader$31 = `#if defined(BUMP)
...
var name$30 = "reflectionFunction";
var shader$30 = `fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
var name$29 = "decalFragment";
var shader$29 = `#ifdef DECAL
...
var name$28 = "pbrBlockAlbedoOpacity";
var shader$28 = `struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
/** @internal */
var pbrBlockAlbedoOpacityWGSL = {
	name: name$28,
	shader: shader$28
};
//#endregion
//#region node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/pbrBlockReflectivity.js
var name$27 = "pbrBlockReflectivity";
var shader$27 = `struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
diffuseRoughness: f32,
reflectanceF0: f32,
...
/** @internal */
var pbrBlockReflectivityWGSL = {
	name: name$27,
	shader: shader$27
};
//#endregion
//#region node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/pbrBlockAmbientOcclusion.js
var name$26 = "pbrBlockAmbientOcclusion";
var shader$26 = `struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
/** @internal */
var pbrBlockAmbientOcclusionWGSL = {
	name: name$26,
	shader: shader$26
};
//#endregion
//#region node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/pbrBlockAlphaFresnel.js
var name$25 = "pbrBlockAlphaFresnel";
var shader$25 = `#ifdef ALPHAFRESNEL
...
/** @internal */
var pbrBlockAlphaFresnelWGSL = {
	name: name$25,
	shader: shader$25
};
//#endregion
//#region node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/pbrBlockAnisotropic.js
var name$24 = "pbrBlockAnisotropic";
var shader$24 = `#ifdef ANISOTROPIC
...
/** @internal */
var pbrBlockAnisotropicWGSL = {
	name: name$24,
	shader: shader$24
};
//#endregion
//#region node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/pbrBlockReflection.js
var name$23 = "pbrBlockReflection";
var shader$23 = `#ifdef REFLECTION
...
/** @internal */
var pbrBlockSheenWGSL = {
	name: name$22,
	shader: shader$22
};
//#endregion
//#region node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/pbrBlockClearcoat.js
var name$21 = "pbrBlockClearcoat";
var shader$21 = `struct clearcoatOutParams
...
/** @internal */
var pbrBlockClearcoatWGSL = {
	name: name$21,
	shader: shader$21
};
//#endregion
//#region node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/pbrBlockIridescence.js
var name$20 = "pbrBlockIridescence";
var shader$20 = `struct iridescenceOutParams
{iridescenceIntensity: f32,
iridescenceIOR: f32,
...
var shader$19 = `struct subSurfaceOutParams
...
var shader$18 = `var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
var name$17 = "bumpFragment";
var shader$17 = `var uvOffset: vec2f= vec2f(0.0,0.0);
...
var name$16 = "pbrBlockNormalFinal";
var shader$16 = `#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
/** @internal */
var pbrBlockNormalFinalWGSL = {
	name: name$16,
	shader: shader$16
};
//#endregion
//#region node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/depthPrePass.js
var name$15 = "depthPrePass";
var shader$15 = `#ifdef DEPTHPREPASS
...
var name$14 = "pbrBlockLightmapInit";
var shader$14 = `#ifdef LIGHTMAP
...
/** @internal */
var pbrBlockLightmapInitWGSL = {
	name: name$14,
	shader: shader$14
};
//#endregion
//#region node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/pbrBlockGeometryInfo.js
var name$13 = "pbrBlockGeometryInfo";
var shader$13 = `var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
/** @internal */
var pbrBlockGeometryInfoWGSL = {
	name: name$13,
	shader: shader$13
};
//#endregion
//#region node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/pbrBlockReflectance.js
var name$12 = "pbrBlockReflectance";
var shader$12 = `#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
/** @internal */
var pbrBlockReflectanceWGSL = {
	name: name$12,
	shader: shader$12
};
//#endregion
//#region node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/pbrBlockDirectLighting.js
var name$11 = "pbrBlockDirectLighting";
var shader$11 = `var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
/** @internal */
var pbrBlockDirectLightingWGSL = {
	name: name$11,
	shader: shader$11
};
//#endregion
//#region node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/lightFragment.js
var name$10 = "lightFragment";
var shader$10 = `#ifdef LIGHT{X}
...
var name$9 = "pbrBlockFinalLitComponents";
var shader$9 = `aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
/** @internal */
var pbrBlockFinalLitComponentsWGSL = {
	name: name$9,
	shader: shader$9
};
//#endregion
//#region node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/pbrBlockFinalUnlitComponents.js
var name$8 = "pbrBlockFinalUnlitComponents";
var shader$8 = `var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
/** @internal */
var pbrBlockFinalUnlitComponentsWGSL = {
	name: name$8,
	shader: shader$8
};
//#endregion
//#region node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/pbrBlockFinalColorComposition.js
var name$7 = "pbrBlockFinalColorComposition";
var shader$7 = `var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
/** @internal */
var pbrBlockFinalColorCompositionWGSL = {
	name: name$7,
	shader: shader$7
};
//#endregion
//#region node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/logDepthFragment.js
var name$6 = "logDepthFragment";
var shader$6 = `#ifdef LOGARITHMICDEPTH
...
var name$5 = "fogFragment";
var shader$5 = `#ifdef FOG
...
var name$4 = "pbrBlockImageProcessing";
var shader$4 = `#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
var name$3 = "pbrBlockPrePass";
var shader$3 = `#if SCENE_MRT_COUNT>0
