...
import { t as ApplyPostProcess } from "./textureTools-CPqs8ajm.js";
...
var RGBDTextureTools = class {
	...
	*/
	static ExpandRGBDTexture(texture) {
		...
		const expandRgbdTextureAsync = async () => {
			...
			internalTexture.isReady = false;
			if (isWebGpu) await import("./rgbdDecode.fragment-DjeJlhvn.js");
	...
	*/
	static async EncodeTextureToRGBD(internalTexture, scene, outputTextureType = 0) {
		if (!scene.getEngine().isWebGPU) await import("./rgbdEncode.fragment-oGWzbCW1.js");
		else await import("./rgbdEncode.fragment-eHGG3MyO.js");
		return await ApplyPostProcess("rgbdEncode", internalTexture, scene, outputTextureType, 1, 5);
	}
};
//#endregion
export { RGBDTextureTools as t };
