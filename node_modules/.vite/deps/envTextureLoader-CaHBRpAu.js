import { I as Logger, p as GetBlobBufferSource } from "./guid-B933-psj.js";
import { o as Vector3 } from "./math.vector.pure-ykbdAlJz.js";
import { a as ILog2 } from "./typeStore-D4_ZTXSQ.js";
import { r as IsExponentOfTwo } from "./tools.functions-DFmBikQS.js";
import { n as InternalTexture } from "./abstractEngine.pure-CkCw37qi.js";
import { n as SphericalPolynomial } from "./sphericalPolynomial.pure-wnKpGHfi.js";
import { t as BaseTexture } from "./baseTexture.pure-PofqupeU.js";
import { r as PostProcess } from "./renderTargetTexture.pure-DgoGBJDL.js";
import { t as CubeMapToSphericalPolynomialTools } from "./cubemapToSphericalPolynomial-D6RhY2D8.js";
...
async function _UploadLevelsAsync(texture, imageData, canGenerateNonLODTextures, imageType = DefaultEnvironmentTextureImageType) {
	...
	if (expandTexture) {
		if (engine.isWebGPU) {
			shaderLanguage = 1;
			await import("./rgbdDecode.fragment-DjeJlhvn.js");
		} else await import("./rgbdDecode.fragment-DUdTLzp5.js");
