import { I as Logger, J as nativeOverride, j as EncodeArrayBufferToBase64, lt as __esDecorate, ut as __runInitializers } from "./guid-B933-psj.js";
import { u as EngineStore } from "./math.vector.pure-ykbdAlJz.js";
import { r as Clamp } from "./typeStore-D4_ZTXSQ.js";
import { n as Tools } from "./tools.pure-D_QeI9lL.js";
import { a as EffectWrapper, i as EffectRenderer } from "./renderTargetTexture.pure-DgoGBJDL.js";
...
async function _CreateDumpResourcesAsync() {
	...
	const { ThinEngine: thinEngineClass } = await import("./thinEngine-D37NANx4.js");
	...
	const { passPixelShader } = await import("./pass.fragment-BI1vBx3N.js");
	return {
		canvas,
		dumpEngine: {
			engine,
...
var EncodingHelper = (() => {
	...
	return _a = class EncodingHelper {
		...
		*/
		...
		__esDecorate(_a, null, _static_EncodeImageAsync_decorators, {
			kind: "method",
			name: "EncodeImageAsync",
			static: true,
			private: false,
			access: {
				has: (obj) => "EncodeImageAsync" in obj,
				get: (obj) => obj.EncodeImageAsync
			},
			metadata: _metadata
...
//#endregion
export { DumpTools as a, DumpFramebuffer as i, DumpData as n, EncodeImageAsync as o, DumpDataAsync as r, RegisterDumpTools as s, Dispose as t };
