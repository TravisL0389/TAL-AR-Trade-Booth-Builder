import { G as _MissingSideEffectProperty, H as Tags, I as Logger, J as nativeOverride, K as _WarnImport, M as ErrorCodes, N as RuntimeError, U as _IsSideEffectImplemented, V as SerializationHelper, W as _MissingSideEffect, Y as serialize, _ as FromHalfFloat, at as serializeAsVector3, d as CopyFloatData, g as GetTypedArrayData, lt as __esDecorate, nt as serializeAsQuaternion, o as LoadImage, ut as __runInitializers } from "./guid-B933-psj.js";
import { a as Vector2, f as Observable, i as TmpVectors, n as Quaternion, o as Vector3, s as Vector4, t as Matrix, u as EngineStore } from "./math.vector.pure-ykbdAlJz.js";
import { m as Epsilon, t as GetClass } from "./typeStore-D4_ZTXSQ.js";
import { n as Color4, t as Color3 } from "./math.color.pure-5sHEvgSw.js";
import { t as Node } from "./node-B9Bjv4U9.js";
import { n as Tools, r as DeepCopier, t as AsyncLoop } from "./tools.pure-D_QeI9lL.js";
import { n as VertexBuffer, r as VertexBufferDeduceStride, t as Buffer } from "./buffer.pure-B9aM3YFS.js";
import { o as PickingInfo, t as SceneComponentConstants } from "./sceneComponent-BCAmy7-x.js";
import { t as AbstractEngine } from "./abstractEngine.pure-CkCw37qi.js";
import { t as Camera } from "./camera.pure-D_lswqgG.js";
import { F as extractMinAndMax, I as BoundingInfo, P as SubMesh, t as Material } from "./material.pure-Dl_VThJ7.js";
import { t as useOpenGLOrientationForUV } from "./compatibilityOptions-Cf3WuxrY.js";
import { n as UniformBuffer } from "./lightConstants-YOTpkEOx.js";
	...
	*/
	static _ImportGeometry(parsedGeometry, mesh) {
		...
		if (geometryUniqueId || geometryId) {
			...
			if (parsedGeometry.matricesIndices) if (!parsedGeometry.matricesIndices._isExpanded && !parsedGeometry.matricesIndicesExpanded) {
				const floatIndices = [];
			...
			if (parsedGeometry.matricesIndicesExtra) if (!(parsedGeometry.matricesIndicesExtraExpanded || parsedGeometry.matricesIndicesExtra._isExpanded)) {
				const floatIndices = [];
...
(_a$2 = TransformNode.prototype).getPhysicsBody ?? (_a$2.getPhysicsBody = _MissingSideEffect("TransformNode", "getPhysicsBody"));
(_b$2 = TransformNode.prototype).applyImpulse ?? (_b$2.applyImpulse = _MissingSideEffect("TransformNode", "applyImpulse"));
(_c$2 = TransformNode.prototype).applyAngularImpulse ?? (_c$2.applyAngularImpulse = _MissingSideEffect("TransformNode", "applyAngularImpulse"));
(_d$1 = TransformNode.prototype).applyTorque ?? (_d$1.applyTorque = _MissingSideEffect("TransformNode", "applyTorque"));
	...
	*/
	_updateInstancedBuffers(subMesh, batch, currentInstancesBufferSize, engine, fillMode, effect) {
		...
		if (!this._instanceDataStorage.manualUpdate && (!instanceDataStorage.isFrozen || needUpdateBuffer)) {
			const world = this.getWorldMatrix();
			if (renderSelf) {
				if (this._scene.needsPreviousWorldMatrices) if (!instanceDataStorage.masterMeshPreviousWorldMatrix) {
...
//#endregion
export { Axis as n, VertexData as r, Mesh as t };
